-- 高潜规则：已留资切 50 条/页前 clear ylz 累加包；wait_ylz_50 改为等首包（去掉 accumulate_grow_by）。
...
SET body = $HRULE061$
{
  ...
  "steps": [
    ...
    {
      "type": "wait",
      "step_id": "wait_after_open_page_size_dropdown",
      "ms": 350
    },
    {
      "type": "wait",
      ...
      "selector": {
        "kind": "css",
        "value": ".leads-select-popover-panel-inner .leads-select-option:has-text('50条/页'):visible",
        "fallbacks": [
          {
            "kind": "css",
            "value": ".leads-select-popover-panel .leads-select-option:has-text('50条/页'):visible"
          },
          {
            "kind": "css",
            "value": ".leads-popover:visible .leads-select-option:has-text('50条/页')"
          },
          {
            "kind": "css",
            "value": ".leads-select-option:has-text('50条/页'):visible"
          }
        ]
      },
      "timeout_ms": 8000
    ...
    {
      "type": "wait",
      "step_id": "wait_after_pick_page_size_wlz",
      "ms": 800
    },
    {
      "type": "wait",
    ...
    {
      "type": "clearCaptureAccumulate",
      "step_id": "clear_ylz_before_page_size_50",
      "keys": [
        "high_dive_ylz_payload"
      ]
    },
    ...
    {
      "type": "wait",
      "step_id": "wait_after_open_page_size_dropdown_ylz",
      "ms": 350
    },
    {
      "type": "wait",
    ...
    {
      "type": "wait",
      "step_id": "wait_after_pick_page_size_ylz",
      "ms": 800
    },
    {
      "type": "wait",
