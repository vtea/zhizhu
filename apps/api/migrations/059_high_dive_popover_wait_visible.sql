-- 高潜规则：popover wait 改用 :visible，避免 .leads-select-option 命中 hidden 导致 SELECTOR_TIMEOUT。
...
SET body = $HRULE059$
{
  ...
  "steps": [
    ...
    },
    {
      ...
      "selector": {
        "kind": "css",
        "value": ".leads-select-popover-panel-inner:visible",
        "fallbacks": [
          {
            "kind": "css",
            "value": ".leads-select-popover-panel:visible"
          },
          {
            "kind": "css",
